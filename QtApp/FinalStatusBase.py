...
class FinalStatusBase(QtWidgets.QFrame):
    ...
    def setupUi(self):
        ...
        self.RemoveDiscount = QtWidgets.QPushButton(self.formLayoutWidget)
        self.RemoveDiscount.setObjectName("RemoveDiscount")
        self.horizontalLayout_6.addWidget(self.RemoveDiscount)
    ...
    def retranslateUi(self):
        ...
        self.RemoveDiscount.setText(_translate("Form", "X"))
        self.pushButton_3.setText(_translate("Form", "5%"))
        self.pushButton.setText(_translate("Form", "10%"))
